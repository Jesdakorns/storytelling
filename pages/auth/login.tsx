...
export const login = ({ dataServer }) => {
    ...
    // const key = await cookies.k_user
...
//     const [loading, setLoading] = useState(state.localStorage ? true : false);
...
//             if (res.data.auth.isAuth) {
//                 await router.push(`/`);
//             } else {
//                 await setAuthSection(res.data.auth);
...
//     useEffect(() => {
//         console.log('authSection ->', loading);
